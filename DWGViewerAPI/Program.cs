...
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.SolidConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.LeaderConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.ViewportConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.DimensionConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.EllipseConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.PolylineConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.SplineConverter>();
builder.Services.AddScoped<DWGViewerAPI.Services.Interfaces.IEntityTypeConverter, DWGViewerAPI.Services.Converters.PointConverter>();
